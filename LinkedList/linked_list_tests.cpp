...
void InsertTests(){
	...
	ll->push_front(4); 
	ll->insert(0, 5);
assert(num_ll_to_string(ll)== "[5, 4, 3, 2]"); 

 ll = new LinkedList<unsigned int>();
	ll->push_front(2);
	ll->push_front(3);
	ll->push_front(4); 
	ll->insert(1, 5);
assert(num_ll_to_string(ll)== "[4, 5, 3, 2]"); 
 ...
 ll = new LinkedList<unsigned int>();
	...
	ll->push_front(4); 
	ll->insert(2, 5); 
  assert(num_ll_to_string(ll)== "[4, 3, 5, 2]"); 
   ...
   ll = new LinkedList<unsigned int>();
	...
	ll->push_front(4); 
	ll->insert(3, 5); 
  assert(num_ll_to_string(ll)== "[4, 3, 2, 5]"); 
